...
//    Ptr<DescriptorExtractor> descriptor = ORB::create();
    ...
    ORB_SLAM2::ORBextractor* orbExtractorL;
    ORB_SLAM2::ORBextractor* orbExtractorR;
    ORB_SLAM2::ORBmatcher* orbMatcher;

    vector<KeyPoint> kpsLeft, kpsRight;
    Mat descLeft, descRight;

    (*orbExtractorL)(imgLeft, cv::Mat(), kpsLeft, descLeft);
    (*orbExtractorR)(imgRight, cv::Mat(), kpsRight, descRight);
