...
BundleParams::BundleParams(int argc, char** argv)
{
    ...
    arg.param("initial_pcd", initial_pcd,"initial.pcd", "Export the BAL file data as a PLY file.");
    arg.param("final_pcd", final_pcd, "final.pcd", "Export the refined BAL file data as a PLY");
